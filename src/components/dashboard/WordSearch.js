...
function WordSearch({ words, render }) {
  ...
  return (
    <div>
      <div className="mt-3 sm:mt-0 sm:ml-4 sm:text-left">
        <h3 className="text-lg leading-6 font-medium text-gray-800">Find a word from your list</h3>
        <div className="mt-2">
          <input
            type="text"
            id="searchword"
            ...
            className=" border rounded-md px-3 py-2 text-gray-800 w-full max-w-md" />
        </div>
        <div className="">
